        ...
        <section className="p-12">
            ...
            <div className="flex justify-around mb-10 bg-[#232732] p-8 rounded-xl">
                <div>
                    ...
                    <h4 className="text-4xl text-[#CCFF00] font-bold">{totalExercises}</h4>
                </div>
                <div>
            ...
            <div className="flex justify-between items-center mb-8">
                <div className="tabs tabs-box bg-[#232732]">
                    ...
                    <input
                        type="radio"
                        name="my_tabs_1"
                        className={`tab text-[#8A92A0] ${activeTab === "saved" ? "bg-[#2B303D] text-white font-semibold" : ""}`}
                        aria-label="Saved"
            ...
            {sortedWorkouts.length === 0 ? (
                ...
                <div className="space-y-5">
                    {sortedWorkouts.map((workout: Exercise) => (
                        <MyPlanCard
                            key={workout.id}
                            workout={workout}
