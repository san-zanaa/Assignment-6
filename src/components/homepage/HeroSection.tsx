    ...
    return (
        <section className='w-[95%] mx-auto flex flex-col md:flex-row justify-between items-center gap-10 md:gap-20 mt-10 p-16 bg-[#222630] rounded-2xl'>
            <div className='text-center md:text-left'>
                ...
                <p className='mb-4 text-[#9CA3AF] text-[16px]'>FitLog is a dark, no-nonsense gym companion: pick a lift, lock it <br className='hidden md:inline'/> into today's plan, and watch the week's work add up.</p>
