    ...
    return (
        <section className='w-[95%] mx-auto flex flex-col md:flex-row justify-between items-center gap-10 md:gap-20 mt-10 p-16 bg-[#222630] rounded-2xl'>
            <div className='text-center md:text-left'>
                ...
                <Link href="#workouts"
                  className="inline-flex w-fit items-center bg-[#C2F800] text-black px-5 py-3 font-bold rounded-md transition-all duration-300 hover:bg-[#c4ec31] cursor-pointer">
